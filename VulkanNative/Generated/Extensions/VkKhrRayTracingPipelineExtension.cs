...
public unsafe class VkKhrRayTracingPipelineExtension
{
    ...
    private delegate* unmanaged[Cdecl]<VkDevice, VkPipeline, uint, uint, nuint, void*, VkResult> _vkGetRayTracingCaptureReplayShaderGroupHandlesKHR;
    ...
    public VkKhrRayTracingPipelineExtension(VkDevice device, IFunctionLoader loader)
    {
        ...
        _vkGetRayTracingCaptureReplayShaderGroupHandlesKHR = (delegate* unmanaged[Cdecl]<VkDevice, VkPipeline, uint, uint, nuint, void*, VkResult>)loader.GetDeviceProcAddr(device, "vkGetRayTracingCaptureReplayShaderGroupHandlesKHR");
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public VkResult VkGetRayTracingCaptureReplayShaderGroupHandlesKHR(VkDevice device, VkPipeline pipeline, uint firstGroup, uint groupCount, nuint dataSize, void* pData)
    {
